...
public partial class admin_Admin : System.Web.UI.Page
{
    ...
    protected void AddUser()
    {
        ...
        switch (createStatus)
        {
            case MembershipCreateStatus.Success:
                ...
                sql = "INSERT INTO AllowAccess (UserId) VALUES ('" + uid + "')";
    ...
    public void delete_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            myObject= Membership.GetUser(username);
            string uid = myObject.ProviderUserKey.ToString();
            ...
            sql = "DELETE FROM AllowAccess WHERE UserId='" + uid + "'";
            ...
            GridView4.DataBind();
            GridView5.DataBind();
            ScriptManager.RegisterStartupScript(Page, GetType(), "Fail", "Deleted();", true);
        }
        catch (Exception ex)
        {
            ...
            oMail1.AlternateViews.Add(htmlView2);
            System.Net.Mail.SmtpClient smtpmail2 = new System.Net.Mail.SmtpClient();
            smtpmail2.Host ="mail.rootcellarboxes.com";
